...
export interface MediaUploadRequestBase {
  /**
...
export interface MediaUploadRequestBinary extends MediaUploadRequestBase {
  /**
...
export interface MediaUploadRequestBase64 extends MediaUploadRequestBase {
  /**
